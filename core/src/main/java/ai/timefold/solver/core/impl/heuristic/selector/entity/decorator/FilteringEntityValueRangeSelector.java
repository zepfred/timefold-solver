...
public final class FilteringEntityValueRangeSelector<Solution_> extends AbstractDemandEnabledSelector<Solution_>
    ...
    public Iterator<Object> iterator() {
        if (randomSelection) {
            return new EntityRandomFilteringValueRangeIterator(this::selectReplayedValue, reachableValues, workingRandom);
        } else {
    ...
    private static class EntityRandomFilteringValueRangeIterator extends UpcomingSelectionIterator<Object> {
        ...
        private EntityRandomFilteringValueRangeIterator(Supplier<Object> upcomingValueSupplier, ReachableValues reachableValues,
