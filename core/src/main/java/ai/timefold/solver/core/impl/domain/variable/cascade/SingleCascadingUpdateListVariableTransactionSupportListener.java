...
/**
 * Differs from {@link SingleCascadingUpdateListVariableListener} because it uses the
 ...
 */
public class SingleCascadingUpdateListVariableTransactionSupportListener<Solution_>
        extends SingleCascadingUpdateListVariableListener<Solution_> {

    SingleCascadingUpdateListVariableTransactionSupportListener(ListVariableDescriptor<Solution_> sourceListVariableDescriptor,
