...
public class TestdataListShadowConstraintVerifierValue extends TestdataObject {
    ...
    private Integer otherCascadingValue;
    ...
    public Integer getOtherCascadingValue() {
        return otherCascadingValue;
    }

    public void setOtherCascadingValue(Integer otherCascadingValue) {
        this.otherCascadingValue = otherCascadingValue;
    }
