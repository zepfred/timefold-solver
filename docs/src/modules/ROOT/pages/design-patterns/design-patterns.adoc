...
== Design patterns introductionxxxx adsf
...
This pattern is implemented using the xref:using-timefold-solver/modeling-planning-problems.adoc#planningListVariable[planning list variable].
